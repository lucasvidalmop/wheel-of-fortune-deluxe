              ...
              <article key={ev.id} className="relative rounded-2xl p-4 sm:p-5 overflow-hidden" style={cardStyle}>
                ...
                <div className="relative flex items-center justify-between gap-2 mb-3 px-1 text-[11px] font-semibold" style={{ color: text }}>
                  <span className="flex items-center gap-1.5 min-w-0">
                    <Calendar size={13} />
                    <span className="truncate tabular-nums" style={closed ? { color: '#f87171', fontWeight: 800, letterSpacing: '0.12em' } : undefined}>{closed ? 'FINALIZADO' : (ev.closes_at ? `Encerra ${formatBetDateTime(ev.closes_at)}` : eventStatusBadge(ev.status))}</span>
                  </span>
