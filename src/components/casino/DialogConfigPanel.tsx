          ...
          <div className="space-y-3 border border-white/[0.06] rounded-xl p-3 bg-white/[0.02]">
            ...
            <div className="space-y-1">
              ...
              <div className="flex items-center gap-1 mt-1">
                <select value={config.postLoginDialogTitleFont ?? 'Inter'} onChange={e => set('postLoginDialogTitleFont', e.target.value)} className="flex-1 px-2 py-1 rounded bg-white/[0.06] border border-white/[0.08] text-foreground text-xs" style={{ colorScheme: 'dark' }}>
