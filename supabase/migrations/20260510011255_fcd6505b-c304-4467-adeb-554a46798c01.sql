ALTER TABLE public.luckybox_grants
  ...
  ADD COLUMN IF NOT EXISTS redeemed_city text,
  ADD COLUMN IF NOT EXISTS redeemed_region text,
  ADD COLUMN IF NOT EXISTS redeemed_country text,
  ADD COLUMN IF NOT EXISTS redeemed_device text,
  ADD COLUMN IF NOT EXISTS redeemed_os text,
  ADD COLUMN IF NOT EXISTS redeemed_browser text;
